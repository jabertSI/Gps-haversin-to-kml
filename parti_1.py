...
distances = [] # LISTE POUR ORDRE CROISSANT
...
print("VILLES AVEC LA DISTANCE ENTRE ELLES DANS L'ORDRE CROISSANT : ")
distances.sort(key=lambda x:x[2]) # FOnction qui dit que le tri se fait sur l'élément N°2 de la liste donc la distance en km
total_km = 0
